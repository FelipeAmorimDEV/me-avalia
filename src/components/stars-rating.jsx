...
const listStyle = { display: 'flex', margin: 0, padding: 0, listStyle: 'none' }
...
function StarRating({ maxRating = 5, color = 'red', size = 48, initialRating, onRating }) {
      ...
      <ul style={listStyle}>
        {Array.from({ length: maxRating }, (_, i) => (
          <Star
            ...
            filled={isRatingGreaterThanIndex(i)}
            onMouseIn={() => handleMouseIn(i)}
